      ...
      <AnimatePresence>
        {isLoaded1 && (
          ...
          >
            ...
            <motion.section 
              className="w-full lg:w-[56%] flex flex-col items-center justify-center p-6 lg:p-16 relative"
            ...
            >
              ...
              {/* 3D Scene container */}
              <motion.div 
                className="relative w-3/5 h-2/5 flex items-center justify-center"
